...
_sales = [
    # Sale(1, 1, _products[0].name, _products[0].price, _products[0].calculate_cost()),
    # Sale(2, 2, _products[1].name, _products[1].price, _products[1].calculate_cost()),
    # Sale(3, 2, _products[1].name, _products[1].price, _products[1].calculate_cost()),
    # Sale(4, 4, _products[3].name, _products[3].price, _products[3].calculate_cost()),
    # Sale(5, 3, _products[2].name, _products[2].price, _products[2].calculate_cost()),
]
